    ...
    <div>
      <header className=' max-w-7xl mx-auto p-2 my-5 bg-black text-white rounded-3xl'>
        <nav className='flex items-center justify-between p-2'>
          <NavLink to='/home' ><h1 className='text-3xl font-bold hidden md:block'>Local Service Marketplace</h1></NavLink>
          <NavLink to='/home' ><h1 className='text-3xl font-bold  md:hidden'>LSP</h1></NavLink>

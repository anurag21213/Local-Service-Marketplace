    ...
    return (
        <div className='p-5 border-b-2 border-slate-700'>
            ...
            <div className='p-10 '>
                ...
                <div className='bg-gradient-to-t from-slate-900 to-black rounded-3xl text-white p-5 flex items-center justify-evenly'>
                    <ul className='p-5 w-[45%]'>
                    ...
                    <div className='bg-white rounded-3xl flex items-center justify-center text-black flex-col p-5'>
                        <img src={img} alt="img"  />
